...
<div id="main">
   ...
   <li><a href="../user/show_plans.php" >Plans</a></li>
   <li><a href="../user/recharge.php">Recharge</a></li>
   ...
   <li><a href="../logout.php">Logout</a></li>
            ...
            <div id="left">
               <ul id="menu2">
                    <li><a href="../user/userhome.php">HOME</a></li>
                    <li><a href="../user/user_profile.php">Profile</a></li>
                    <li><a href="../user/user_plans.php">Plans</a></li>
                    <li><a href="../user/myaccount.php">My Account</a></li>
                    <li><a href="../user/recharge.php">Recharge</a></li>
