           ...
           <marquee  direction="up" scrollamount="2"  onmouseover="this.setAttribute('scrollamount', 0, 0);" onmouseout="this.setAttribute('scrollamount', 3, 0);">
            ...
            <?php 
				...
				while($rw=mysql_fetch_array($result))
				{
					...
					?>
                    <h3>Plan Name : <?php echo $plan_name; ?></h3>
                    <h3>Plan Id : <?php echo $planid; ?></h3>
                    <h3>Cost : <?php echo $amt; ?></3>
                    <h3>Validity : <?php echo $validity; ?></h3>
                    <h3>Balance : <?php echo $balance; ?></h3>
                    <h3>Free SMS : <?php echo $free_sms; ?></h3>
                    <h3>Free Data : <?php echo $free_data; ?></h3>
                    <h3>Free Calls : <?php echo $free_calls; ?></h3>
                    <hr />
					<?php
				}
			?>
