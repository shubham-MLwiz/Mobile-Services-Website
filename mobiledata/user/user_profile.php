...
?>
<p>Name : <?php echo $rw["name"]; ?> </p>
<p>Father's Name  : <?php echo $rw["ftname"]; ?> </p>
<p>Mothors' Name  : <?php echo $rw["mtname"]; ?> </p>
<p>Address   : <?php echo $rw["address"]; ?></p>
<p>City   : <?php echo $rw["city"]; ?></p>
<p>State  : <?php echo $rw["state"]; ?> </p>
<p>Pin   : <?php echo $rw["pin"]; ?></p>
<p>Email  : <?php echo $rw["email"]; ?> </p>
<p>Mobile Number  : <?php echo $rw["mobile_no"]; ?> </p>
<p>Alternate Number  : <?php echo $rw["alt_no"]; ?> </p>
<p>DOB  : <?php echo $rw["dob"]; ?></p>
