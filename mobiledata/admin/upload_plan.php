...
$planid=GenerateId("plan_master",1);
$planname=$_POST["T1"];
$amt=$_POST["T2"];
$balance=$_POST["T3"];
$validity=$_POST["T4"];
...
$free_data=$_POST["T6"];
$free_calls=$_POST["T7"];
$query="insert into plan_master values($planid,'$planname',$amt,$balance,$validity,$free_sms,$free_data,$free_calls)";
//echo $query; die();
mysql_query($query);
...
?>
<h1>Plan Registered Successfully and Plan ID : <?php echo $planid; ?></h1>
            <p>&nbsp;</p>
            <p>&nbsp;</p>
            <p>&nbsp;</p>
