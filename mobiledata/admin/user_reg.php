...
$comment=$_POST["T12"];
$dob=$_POST["T13"];
$query="insert into userdata values ('$name', '$ftname', '$mtname','$address','$city','$state',$pin,'$email','$mobile','$alt_no','$add_proof','$dealer','$comment','$dob',1,'a','nothing')";
//echo $query;die();
mysql_query($query);
...
<p><a href="user_reg_form.php">Add More...</a></p>
