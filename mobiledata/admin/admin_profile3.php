...
$email=$_POST["T4"];
$contact=$_POST["T5"];
$query="update admindata set address='$address',city='$city',state='$state',email='$email',contact='$contact' where username='$username'";
//echo $query;die();
mysql_query($query);
?>
<h1>Data Saved</h1>
<p><a href="adminhome.php">Continue...</a></p>
